...
<head lang="en">
    <meta charset="UTF-8">
    <title>PreLoad the Information To be Updated in the Employees</title>
    <script src="script.js"></script>
</head>
<body>

<form id="myForm" name="myForm" method="post" action="update_emp.php" onsubmit="return checkForm()">
    <?php
